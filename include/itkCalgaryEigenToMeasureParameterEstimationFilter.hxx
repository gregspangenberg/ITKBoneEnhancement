...
CalgaryEigenToMeasureParameterEstimationFilter<TInputImage,
                                               TOutputImage>::CalgaryEigenToMeasureParameterEstimationFilter()
  : Superclass()
  , m_FrobeniusNormWeight(0.5)
{
  /* Set parameter size to 2 */
...
template <typename TInputImage, typename TOutputImage>
void
CalgaryEigenToMeasureParameterEstimationFilter<TInputImage, TOutputImage>::BeforeThreadedGenerateData()
{
...
template <typename TInputImage, typename TOutputImage>
void
CalgaryEigenToMeasureParameterEstimationFilter<TInputImage, TOutputImage>::AfterThreadedGenerateData()
{
...
template <typename TInputImage, typename TOutputImage>
void
CalgaryEigenToMeasureParameterEstimationFilter<TInputImage, TOutputImage>::DynamicThreadedGenerateData(
...
CalgaryEigenToMeasureParameterEstimationFilter<TInputImage, TOutputImage>::CalculateFrobeniusNorm(
...
template <typename TInputImage, typename TOutputImage>
void
CalgaryEigenToMeasureParameterEstimationFilter<TInputImage, TOutputImage>::PrintSelf(std::ostream & os,
                                                                                     Indent         indent) const
{

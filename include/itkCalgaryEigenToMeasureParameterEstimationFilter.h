 ...
 * If a mask is given, parameters are evaluated only where IsInsideInObjectSpace
 * returns true.
 *
 * \sa CalgaryEigenToMeasureImageFilter
...
{
public:
  ITK_DISALLOW_COPY_AND_MOVE(CalgaryEigenToMeasureParameterEstimationFilter);
  ...
  itkOverrideGetNameOfClassMacro(CalgaryEigenToMeasureParameterEstimationFilter);
...
protected:
  ...
  ~CalgaryEigenToMeasureParameterEstimationFilter() override = default;

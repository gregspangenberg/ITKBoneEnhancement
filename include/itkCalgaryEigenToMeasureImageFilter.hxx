...
CalgaryEigenToMeasureImageFilter<TInputImage, TOutputImage>::CalgaryEigenToMeasureImageFilter()
  : m_EnhanceType(-1.0)
{}

template <typename TInputImage, typename TOutputImage>
void
CalgaryEigenToMeasureImageFilter<TInputImage, TOutputImage>::BeforeThreadedGenerateData()
{
...
CalgaryEigenToMeasureImageFilter<TInputImage, TOutputImage>::ProcessPixel(const InputImagePixelType & pixel)
{
  /* Grab parameters */
  ParameterArrayType parameters = this->GetParametersInput()->Get();
  ...
  /**
   * Compute bone and noise measures.
   */
...
template <typename TInputImage, typename TOutputImage>
void
CalgaryEigenToMeasureImageFilter<TInputImage, TOutputImage>::PrintSelf(std::ostream & os, Indent indent) const
{
